...
sh ${BASH_FOLDER}/step3-hisat2.sh --experiment ${EXPERIMENT} --prefix ${PREFIX} --cores ${CORES} --index ${HISATIDX} --bed ${BED} --large ${LARGE} --stranded ${STRANDED} --unaligned ${UNALIGNED}
sh ${BASH_FOLDER}/step4-featureCounts.sh --experiment ${EXPERIMENT} --prefix ${PREFIX} --cores ${CORES} --stranded ${STRANDED} --gtf ${GTF} --reference ${hgXX} --large ${LARGE}
...
sh ${BASH_FOLDER}/step7-makeRobjects.sh --experiment ${EXPERIMENT} --prefix ${PREFIX} --cores ${CORES} --reference ${hgXX} --ercc ${ERCC} --large ${LARGE} --fullcov ${FULLCOV} --bashfolder ${BASH_FOLDER} --stranded ${STRANDED}
