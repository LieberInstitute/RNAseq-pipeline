...
gencode_vM11 = import(con = "../GENCODE/GRCm38_mm10/gencode.vM11.annotation.gtf", format = "gtf")
...
## read in GTF as GRanges
ensembl_v86 = import(con = "../ensembl/Mus_musculus.GRCm38.86.gtf", format = "gtf")
...
## read in GTF as GRanges
ensembl_v86 = import(con = "../ensembl/Rnor_6.0/Rattus_norvegicus.Rnor_6.0.86.gtf", format = "gtf")
