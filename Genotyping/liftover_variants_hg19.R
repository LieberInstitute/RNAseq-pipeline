...
## Keep hg19 coordinates, unlike https://github.com/LieberInstitute/RNAseq-pipeline/blob/master/Genotyping/liftover_variants.R
snpMapGR = snpMapGR[x$RefSNP_id] # drop those that didnt match up
# identical(pos(x), start(liftedSnps)) # TRUE

## write out
export(snpMapGR, con = "common_missense_SNVs_hg19.bed")
